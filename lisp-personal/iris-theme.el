...
(custom-theme-set-faces
 ...
 '(diredfl-compressed-file-suffix ((((class color) (min-colors 89)) (:foreground "#4271ae"))))
 '(diredfl-compressed-file-name ((((class color) (min-colors 89)) (:foreground "#4271ae"))))
 ...
 '(diredfl-date-time ((((class color) (min-colors 89)) (:foreground "#4271ae"))))
 '(diredfl-dir-heading ((((class color) (min-colors 89)) (:foreground "#718c00" :weight bold))))
 '(diredfl-dir-name ((((class color) (min-colors 89)) (:foreground "#3e999f"))))
 '(diredfl-dir-priv ((((class color) (min-colors 89)) (:foreground "#3e999f" :background nil))))
 '(diredfl-exec-priv ((((class color) (min-colors 89)) (:foreground "#f5871f" :background nil))))
 '(diredfl-executable-tag ((((class color) (min-colors 89)) (:foreground "#c82829" :background nil))))
 '(diredfl-file-name ((((class color) (min-colors 89)) (:foreground "#eab700"))))
 '(diredfl-file-suffix ((((class color) (min-colors 89)) (:foreground "#718c00"))))
 '(diredfl-flag-mark ((((class color) (min-colors 89)) (:foreground "#718c00" :inverse-video t))))
 '(diredfl-flag-mark-line ((((class color) (min-colors 89)) (:background nil :inherit highlight))))
 '(diredfl-ignored-file-name ((((class color) (min-colors 89)) (:foreground "#8e908c"))))
 '(diredfl-link-priv ((((class color) (min-colors 89)) (:background nil :foreground "#8959a8"))))
 '(diredfl-no-priv ((((class color) (min-colors 89)) (:background nil))))
 '(diredfl-number ((((class color) (min-colors 89)) (:foreground "#eab700"))))
 '(diredfl-other-priv ((((class color) (min-colors 89)) (:background nil :foreground "#8959a8"))))
 '(diredfl-rare-priv ((((class color) (min-colors 89)) (:foreground "#c82829" :background nil))))
 '(diredfl-read-priv ((((class color) (min-colors 89)) (:foreground "#718c00" :background nil))))
 '(diredfl-symlink ((((class color) (min-colors 89)) (:foreground "#8959a8"))))
 '(diredfl-write-priv ((((class color) (min-colors 89)) (:foreground "#eab700" :background nil))))
